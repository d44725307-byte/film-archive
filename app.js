...
(async function () {
  ...
  async function makePoster(f) {
    ...
    if (f.notes) {
      ...
      contentBottom = wrapText(ctx, f.notes, 84, contentBottom + 100, W - 168, 50, 4);
    }
    // 实拍样片缩略图
